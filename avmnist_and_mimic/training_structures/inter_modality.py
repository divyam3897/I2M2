...
def deal_with_objective(objective, pred, truth, args):
    ...
    if type(objective) == nn.CrossEntropyLoss or type(objective) == nn.NLLLoss:
...
def train(
        ...
        objective=nn.CrossEntropyLoss(), auprc=False, save_dir='./ckpts/md.pt', validtime=False, objective_args_dict=None, input_to_float=True, clip_val=8,
